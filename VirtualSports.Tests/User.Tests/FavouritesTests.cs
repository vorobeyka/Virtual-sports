...
namespace VirtualSports.Tests.User.Tests
{
    public class FavouritesTests
    {
        ...
        [Fact]
        public async Task Should_Return_Ok_When_Adding_To_Favourites()
        {
            using (var mock = AutoMock.GetLoose())
            {
                ...
                userService.Setup(u =>
                    u.AddFavouriteAsync(login, "original_dice_game", platform, cancellationToken));
                ...
                var claims = new List<Claim>
            {
                ...
                //Act
                var result = await controller.AddToFavourites("original_dice_game", cancellationToken);

                //Assert
                Assert.NotNull(result);
                userService.Verify(u =>
                    u.AddFavouriteAsync(login, "original_dice_game", platform, cancellationToken), Times.Once);
                Assert.IsType<OkResult>(result);
            }
        }

        [Fact]
        public async Task Should_Return_Ok_When_Deleting_From_Favourites()
        {
            using (var mock = AutoMock.GetLoose())
            {
                //Arrange
                ...
                userService.Setup(u =>
                    u.DeleteFavouriteAsync(login, "original_dice_game", cancellationToken));
                ...
                //Act
                var result = await controller.DeleteFromFavourites("original_dice_game", cancellationToken);

                //Assert
                Assert.NotNull(result);
                userService.Verify(u =>
                    u.DeleteFavouriteAsync(login, "original_dice_game", cancellationToken), Times.Once);
                Assert.IsType<OkResult>(result);
            }
        }
        ...
        public async Task Should_Return_Ok_When_Requesting_Favourites()
        {
            using (var mock = AutoMock.GetLoose())
            {
                ...
                userService.Setup(u =>
                    u.GetFavouritesAsync(login, platform, cancellationToken)).ReturnsAsync(gameDtos);
                ...
                var claims = new List<Claim>
            {
                ...
                Assert.NotNull(result);
                userService.Verify(u =>
                    u.GetFavouritesAsync(login, platform, cancellationToken), Times.Once);
